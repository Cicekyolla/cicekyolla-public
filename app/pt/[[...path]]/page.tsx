// GLOBAL 14-dil — /pt/* locale yüzeyi (ince sarmalayıcı; motor lib/global/page).
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  return localeMetadata("pt", params.path ?? []);
}

export default function Page({ params, searchParams }: Props) {
  // ?category / ?page yalnız lokasyon kataloğu sayfalaması içindir; metadata (canonical) sorgusuz kalır.
  return <LocalePage locale="pt" path={params.path ?? []} searchParams={searchParams} />;
}
