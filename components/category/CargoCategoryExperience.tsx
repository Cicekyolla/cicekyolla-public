...
const DEFAULT_FEATURES = [
  { title: "İstanbul Aynı Gün", text: "İstanbul içi uygun adreslerde aynı gün teslim; kesin saat sipariş adımında görünür.", kind: "clock" },
  ...
  return <main className="bg-white text-[#111827]">
    <section className="relative overflow-hidden bg-[linear-gradient(115deg,#0b0319_0%,#241048_48%,#6D28D9_100%)] px-6 py-20 lg:px-14 lg:py-28">
      ...
      <div className="relative mx-auto max-w-[1370px]">
        ...
        <div className="mt-10 flex flex-wrap gap-4"><a href="#kargo-urunleri" className="inline-flex min-h-14 items-center gap-3 rounded-full bg-white px-8 font-bold text-[#6D28D9]">Ürünleri Keşfet <ArrowRight className="h-5 w-5" /></a><a href="https://wa.me/905458813450?text=Merhaba%2C%20kargo%20ile%20g%C3%B6nderilebilen%20%C3%BCr%C3%BCnler%20hakk%C4%B1nda%20bilgi%20almak%20istiyorum." target="_blank" rel="noopener noreferrer" className="inline-flex min-h-14 items-center gap-3 rounded-full border border-white/30 px-8 font-bold text-white"><MessageCircle className="h-5 w-5" />WhatsApp'tan Yaz</a></div>
      </div>
    </section>
