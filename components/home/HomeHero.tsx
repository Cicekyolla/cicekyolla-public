...
/**
 * §1 CINEMATIC HERO — ZIP "Next-Gen Ecommerce Website Design" / Homepage.tsx birebir port.
 *
 ...
 * - overflow:visible KORUNDU → Adım 2'de FloatingCategoryRail (bottom:-118px) hero sınırının altına taşacak.
 *
...
export function HomeHero() {
  ...
  return (
    ...
    >
      ...
      {/* ──────────────────────────────────────────────────────────
          §2 SLOT — Floating Koleksiyonlar (FloatingCategoryRail)
          8B-2.2 Adım 2 buraya gelecek (ZIP birebir):
            <motion.div className="absolute left-0 right-0 z-30" style={{ bottom: "-118px" }}>
              <FloatingCategoryRail />
            </motion.div>
          Gereksinim: embla-carousel-react (package.json'a eklenecek) + premiumCategories verisi.
          Section overflow:visible bu yüzden ŞİMDİDEN korunuyor.
      ────────────────────────────────────────────────────────── */}
    </section>
  );
}
